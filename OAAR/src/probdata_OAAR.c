 ...
 * @author He Xingqiu
 *
 * TODO: briefly comment this file
 **/
...
struct SCIP_ProbData
{
   ...
   OAARTopology*         Topology;     /**< Topology of the problem */
   OAARFlow**            Flow;         /**< Flow array storing all user defined flow infomation */ 
   int                   nFLow;        /**< Number of flows */
...
SCIP_RETCODE probdataCreate(
   ...
   OAARTopology*         Topology,           /**< Topology structure */
   OAARFlow**            Flow,               /**< Flow information */
   int                   nFlow,              /**< number of flows */
